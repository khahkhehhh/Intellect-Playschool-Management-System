...
<div class="container">
  ...
  <tbody>
	 ...
	 while($row=mysqli_fetch_array($result))
	 {
		 ...
		 echo "<td>";
			   echo "<a href= 'funkindyview.php?id=".$row['k_mykid']."'class ='btn btn-warning'>View  </a> &nbsp";
			   echo "</td>";
			   echo "<td>";
			   echo "<a href= 'funkindymodify.php?id=".$row['k_mykid']."'class ='btn btn-dark'>Modify</a> &nbsp";
			   echo "</td>";
			   echo "<td>";
			   echo "<a href= 'funkindydelete.php?id=".$row['k_mykid']."'class ='btn btn-danger'>Delete</a>";
