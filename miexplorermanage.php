...
<div class="container">
  ...
  <tbody>
     ...
     while($row=mysqli_fetch_array($result))
     {
         ...
         echo "<td>";
               echo "<a href= 'miexplorerview.php?id=".$row['mu_id']."'class ='btn btn-warning'>View  </a> &nbsp";
               echo "</td>";
               echo "<td>";
               echo "<a href= 'miexplorermodify.php?id=".$row['mu_id']."'class ='btn btn-dark'>Modify</a> &nbsp";
               echo "</td>";
               echo "<td>";
               echo "<a href= 'miexplorerdelete.php?id=".$row['mu_id']."'class ='btn btn-danger'>Delete</a>";
