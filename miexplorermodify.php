...
<body>
  ...
  <form method ="POST" action="miexplorermodifyprocess.php" enctype="multipart/form-data">
<br><br>
<h2 style="text-align: center;  font-family: 'Times New Roman';">Multiple Intelligence</h2><br>
 ...
 <fieldset>
  ...
  <legend>Session : <?php echo $row['session_desc']?></legend>
       <div class="form-group">
...
<a href= 'miexplorermanage.php'class ='btn btn-dark'>Back</a> 
