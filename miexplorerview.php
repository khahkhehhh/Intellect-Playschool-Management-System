...
<div>
       ...
       <div class="form-group" >
       <h4 style="font-family:Times New Roman;"for="exampleInputEmail1" class="form-label mt-4">Kid ID : <?php echo $row['k_mykid']?></h4>
      </div>
...
<div class="text-center">
        ...
        <a href= 'miexplorermanage.php'class ='btn btn-warning'>Back</a> 
</div>
