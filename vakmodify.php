...
<div class = "container">
  ...
  <form method ="POST" action="vakmodifyprocess.php" >
    <fieldset>

       <div class="form-group">
      <label for="exampleInputPassword1" class="form-label mt-4">Assessment ID</label>
      <input  style="width:250px;"  type="text" name="vakid" class="form-control" id="exampleInputPassword1"  value="<?php echo $row['exp_id']?>"required>
    </div>
...
<input type="hidden" name="vakid" value="<?php echo $expid;?>">
<br><br><br>

<a href= 'vakmanage.php'class ='btn btn-primary'>Back</a> 
